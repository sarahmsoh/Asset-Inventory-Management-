    ...
    <div className="container py-4">
      ...
      <div className="row mb-3">
        ...
        <div className="col-md-6 d-flex flex-column justify-content-between">
          <button className="btn text-white mb-3" style={{ backgroundColor: "blue" }} onClick={() => navigate("/manage-assets")}>
            View Assets
          </button>
          <button className="btn text-white mb-3" style={{ backgroundColor: "green" }} onClick={() => navigate("/allocation-assert")}>
            Allocate Assets
          </button>
          <button className="btn text-white mb-3" style={{ backgroundColor: "aqua" }} onClick={() => navigate("/rejected")}>
            Approve/Reject Requests
          </button>
          <button className="btn text-white" style={{ backgroundColor: "darkgoldenrod" }} onClick={() => navigate("/completed-requests")}>
            Completed Requests
          </button>
        </div>
      </div>
